...
namespace SBX_ERP
{
    public partial class frm_agregar_gasto : Form
    {
        ...
        frm_busquedas frm_Ayuda = new frm_busquedas();
        private void btn_buscar_proveedor_Click(object sender, EventArgs e)
        {
            if (frm_Ayuda == null || frm_Ayuda.IsDisposed)
            {
                ...
                frm_Ayuda.Modulo = 9;
                frm_Ayuda.Enviainfo += new frm_busquedas.EnviarInfo(mtd_dato_proveedor);
        ...
        private void mtd_dato_proveedor(string info)
        {
